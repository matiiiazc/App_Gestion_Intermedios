from PySide6.QtWidgets import (
    ...
    QDialogButtonBox, QComboBox, QDoubleSpinBox, QDateEdit
)
...
class PresupuestosView(QWidget):
    ...
    def cargar_presupuestos(self):
        ...
        self.tabla.setRowCount(len(self.presupuestos_cache))

        for fila, presupuesto in enumerate(self.presupuestos_cache):
            valores = [
            presupuesto["id_presupuesto"],
            presupuesto["cliente"],
            presupuesto["tipo_trabajo"],
            presupuesto["fecha_ingreso"],
            presupuesto["fecha_inicio"] or "",
            presupuesto["fecha_expiracion"] or "",
            presupuesto["total"],
            presupuesto["estado"] if "estado" in presupuesto.keys() else "Pendiente",
            ]
    ...
    def presupuesto_seleccionado(self):
        ...
        return self.presupuestos_cache[fila]
    ...
    def eliminar_presupuesto(self):
        ...
        respuesta = QMessageBox.question(
            ...
            "Seguro que queres eliminar este presupuesto?"
        )
    ...
    def aceptar_presupuesto(self):
        ...
        if estado == "Aceptado":
            QMessageBox.information(
                ...
                "Este presupuesto ya fue aceptado y pasado a pedidos."
            )
            return
        ...
        if respuesta == QMessageBox.Yes:
            ...
            if creado:
                ...
                QMessageBox.information(
                    ...
                    "El presupuesto se agrego automaticamente a pedidos."
                )
            else:
                QMessageBox.warning(
                    self,

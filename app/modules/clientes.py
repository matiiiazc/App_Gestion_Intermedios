...
class ClientesModule:
    ...
    def crear_particular(self, nombre, apellido, telefono="", cuil="",
    ...
    def crear_empresa(self, nombre_empresa, telefono="", direccion="",
    ...
    def editar_particular(self, id_cliente, nombre, apellido, telefono="",
                          cuil="", dni="", condicion_iva="", direccion="",
                          localidad="", provincia="", email=""):
    ...
    def editar_empresa(self, id_cliente, nombre_empresa, telefono="",
                       direccion="", cuil="", condicion_iva="",
                       localidad="", provincia="", email=""):
    ...
    def tiene_datos_facturacion(self, id_cliente):
        return self.db.cliente_tiene_datos_facturacion(id_cliente)
